...
var Selectable = (function (_Component) {
  ...
  _createClass(Selectable, [{
    ...
    value: function _mouseUp(e) {
      ...
      var inRoot = isNodeInRoot(e.target, _react2['default'].findDOMNode(this));
    ...
    value: function _selectElement(x, y) {
      ...
      _react2['default'].Children.forEach(this.props.children, function (child) {
        var node = _react2['default'].findDOMNode(_this2.refs['selectable_' + child.key]);
    ...
    value: function _selectElements(e) {
      ...
      _react2['default'].Children.forEach(this.props.children, function (child) {
        var collision = _this3._objectsCollide(_react2['default'].findDOMNode(_this3.refs.selectbox), _react2['default'].findDOMNode(_this3.refs['selectable_' + child.key]), _this3.props.tolerance);
        if (collision) {
          currentItems.push(child.key);
        }
      }, this);
